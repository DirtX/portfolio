export const translations = {
  en: {
    ...
    hero_desc: 'Translating visual concepts into clean, functional code. Bridging design and engineering without friction.',
    ...
    about_p1: 'Frontend developer with 4 years of freelance experience building responsive websites and interfaces.',
    about_p2: 'My background in UI/UX design gives me an edge — I can go from mockup to working code without handoff friction.',
  ...
  cz: {
    ...
    hero_desc: 'Převádím vizuální koncepty do čistého, funkčního kódu. Propojuji design a vývoj bez zbytečných překážek.',
    ...
    about_p1: 'Frontend developer s 4 lety zkušeností z freelance — tvorba responzivních webů a rozhraní.',
